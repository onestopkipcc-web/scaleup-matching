...
- 서류 제출 안내
        ...
        TEMPLATES = {
            "7월 교육 프로그램 신청 안내": {
                "subject": "[원스톱 스케일업] 7월 교육 프로그램 참여 신청 안내",
                "body": """안녕하세요, 원스톱 스케일업 운영팀입니다.

선정 기업 여러분께 매월 전문가 강의와 밋업 행사를 제공해드리고 있습니다.
이번 달에는 두 가지 프로그램을 안내드리오니, 참여를 원하시는 경우 7월 17일(목)까지 이 메일에 답장으로 신청해 주세요.
...
주  제: AI 마케팅 / 콘텐츠 제작 활용
        — 생성형 AI를 활용한 SNS 마케팅, 홍보 콘텐츠 제작,
          미리캔버스·캡컷 실습 등 실무 중심으로 진행됩니다.
강  사: 송윤경 강사 (소상공인연합회)
일  시: 2026년 7월 29일(수) 14:00 ~ 16:00 (질의응답 포함)
방  식: 온라인 (Zoom)

줌 링크 및 교육 자료는 교육 전주 초에 별도 안내드릴 예정입니다.

─────────────────────────────────
📌 프로그램 2 | CES 혁신상 수상 노하우 밋업
─────────────────────────────────

주  제: CES 혁신상 수상 노하우 공유
        — 실제 CES 혁신상 수상 경험을 가진 전문가의 노하우 공유 및
          2027 CES 도전을 준비하는 기업 대상 Q&A 진행
...
7월  | AI 마케팅 / 콘텐츠 제작 활용
8월  | 디지털 마케팅
9월  | 네이버 크리에이터 & 비즈니스 플랫폼 활용
10월 | 특허·상표권·디자인권 보호
11월 | 해외 ODA 시장 진출 및 KOICA 무상원조 참여방안
12월 | 해외 지식재산권 보호 지원사업 및 활용사례

※ 상시: 조달·혁신제품 개별 컨설팅 (매월 2~3개사 한정)

─────────────────────────────────
▣ 신청 방법
─────────────────────────────────

이 메일에 아래 내용 작성 후 답장해 주세요.
